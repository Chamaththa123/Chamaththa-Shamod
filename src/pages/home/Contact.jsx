...
export const Contact = ({ scrollref }) => {
  ...
  return (
    <animated.section
      ref={ref}
      style={fadeScreen}
      className="overflow-hidden flex p-[30px] py-[60px] xl:px-[8%] xl:py-[4%] flex-col gap-20  w-full h-auto "
    >
      <div className=" w-full flex flex-col gap-7 xl:gap-4 items-start">
        <div ref={scrollref} />
        <animated.div className="text-center text-[#40b93c] text-4xl font-medium xl:leading-[60px]">
          Contact{" "}
        </animated.div>
        <animated.div
          style={fadeTitle}
          className="text-black w-full xl:text-5xl text-3xl font-bold xl:leading-[70px] leading-[50px] relative"
        >
          GET IN TOUCH
        </animated.div>
        ...
        <animated.div
          style={fadeTitle}
          className="text-black w-full xl:text-lg text-[18px] md:w-[60%] font-normal xl:leading-[30px] leading-[30px] relative"
        >
