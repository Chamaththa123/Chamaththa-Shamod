...
export const AboutUs = ({ scrollref }) => {
	...
	return (
		<animated.section style={fadeScreen} ref={ref} className='overflow-hidden flex p-[30px] py-[60px] xl:px-[5%] xl:py-[4%] xl:flex-row flex-col gap-[5%] items-center w-full h-auto'>
<div className='relative hidden xl:flex xl:w-[50%] h-[100%]  flex-col gap-5  items-center justify-center '>
			...
			<div className=' xl:w-[50%] flex flex-col gap-7 xl:gap-1 items-start'>
				<div ref={scrollref} />
				<animated.div className="text-center text-[#40b93c] text-4xl font-medium xl:leading-[60px]" style={fadeSubTitle}>
					About Me
				</animated.div>
